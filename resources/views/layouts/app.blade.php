...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
		...
		@if (request()->routeIs(['customers.index', 'customers.show', 'airway_bills.index', 'airway_bills.show']))
            ...
            <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <x-jet-responsive-nav-link href="{{ url('customers') }}" :active="request()->routeIs('customers')">
                            {{ __('Customers') }}
                        </x-jet-responsive-nav-link>
                        <x-jet-responsive-nav-link href="{{ url('airway_bills') }}" :active="request()->routeIs('airway_bills')">
                            {{ __('Airway Bills') }}
                        </x-jet-responsive-nav-link>
                    </div>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            <!-- Account Management -->
                            <x-jet-responsive-nav-link href="{{ url('user/profile') }}" :active="request()->routeIs('profile.show')">
                                {{ __('Profile') }}
                            </x-jet-responsive-nav-link>
